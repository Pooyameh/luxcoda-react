        ...
        >
          {navLinks.map((link) => (
            <a
              ...
              onMouseLeave={(e) => (e.target.style.color = 'rgba(240,240,255,0.78)')}
            >
              {link.label}
            </a>
          ))}
          ...
          <MockupDialog
            trigger={
              <Button
                ...
                style={{ height: 38, padding: '0 20px', borderRadius: 8, fontSize: '0.85rem' }}
              >
                Free Mock-Up
              </Button>
            }
      ...
      {menuOpen && (
        ...
        >
          ...
          <div style={{ marginTop: 16 }}>
            <MockupDialog
              trigger={
                <Button className="gradient-btn" style={{ width: '100%', height: 46, borderRadius: 10 }}>
                  Claim Free Mock-Up
                </Button>
              }
            />
